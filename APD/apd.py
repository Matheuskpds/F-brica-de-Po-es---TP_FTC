    ...
    def processar_input_apd(self, caminho_do_arquivo):
        ...
        while True:
            if resposta == 's':
                ...
                if(empilha == 'B'):
                    print("Efeito: Aumentou o brilho da funcao!")
                if(desempilha == 'B'):
                    print("Efeito: Diminuiu o brilho da funcao!")  
                if(empilha == 'T' or empilha == 'TT'):
                    print("Efeito: Aumentou a temperatura da funcao!")
                if(desempilha == 'T'):
                    print("Efeito: Diminuiu a temperatura da funcao!")   
...
def ler_arquivo_apd(arquivo):
    ...
    for linha in linhas:
        ...
        elif linha.startswith('F:'): # Leitura do estado final
